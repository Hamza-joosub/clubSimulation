...
public class ClubSimulation {
	...
	private static final int maxWait=1200; //for the slowest customer
	private static final int minWait=500; //for the fastest cutomer

	protected static AtomicBoolean simStarted = new AtomicBoolean(false);

	protected static AtomicBoolean isPaused = new AtomicBoolean(false);


	public static CountDownLatch entryLatch = new CountDownLatch(1);
