...
public class ClubSimulation {
	...
	public static void setupGUI(int frameX,int frameY,int [] exits) {
      	...
      	for (int i=0;i<noClubgoers;i++) 
		{
		    ...
		    public void actionPerformed(ActionEvent e)  {	
				if(clubGrid.getPaused() == false)  
				{
					clubGrid.setPaused(true);
				}
				else
				{
					clubGrid.setPaused(false);
				}
	...
	public static void main(String[] args) throws InterruptedException {
		...
		*/
		...
		clubGrid = new ClubGrid(gridX, gridY, exit,tallys,patrons ); //setup club with size and exitsand maximum limit for people    
